...
Contributions are welcome. If you discover bugs or issues, or have
ideas for improvements or new features, please file a report on the
issue tracker for this repository. Follow the guidelines below to make
...
- Use a `emacs-kinopoisk-` prefix for all public names.
- Use a `emacs-kinopoisk--` prefix for all internal names.
